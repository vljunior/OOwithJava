...
public final class GeradorIdentificadorUnicoModificado {

    // Contadores atômicos para IDs inteiros
    private static final AtomicInteger contadorInt = new AtomicInteger(500);
    private static final AtomicLong contadorLong = new AtomicLong(500);

    private GeradorIdentificadorUnicoModificado() {
        // Impede instanciação
    }
    ...
    public static void setValorInicialInt(int valor) {
    contadorInt.set(valor);
    }
